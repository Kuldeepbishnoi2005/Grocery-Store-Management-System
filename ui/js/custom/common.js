...
var productListApiUrl = 'http://127.0.0.1:5001/getProducts';
var uomListApiUrl = 'http://127.0.0.1:5001/getUOM';
var productSaveApiUrl = 'http://127.0.0.1:5001/insertProduct';
var productDeleteApiUrl = 'http://127.0.0.1:5001/deleteProduct';
var orderListApiUrl = 'http://127.0.0.1:5001/getAllOrders';
var orderSaveApiUrl = 'http://127.0.0.1:5001/insertOrder';

// For product drop in order (this one is ok, external API)
